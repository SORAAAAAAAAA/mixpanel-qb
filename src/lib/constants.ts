...
export const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary: 'text-foreground hover:text-[#4f44e0] hover:bg-[#7b80ff]/2 dark:hover:bg-[var(--primary)]/3 dark:hover:text-[#7b80ff] transition-colors duration-200 cursor-pointer',
